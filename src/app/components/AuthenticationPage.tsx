  ...
  return (
    <>
      <div className="container relative h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative md:hidden z-20 py-8 flex items-center text-lg font-medium">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <div className="mx-auto flex w-full flex-col mt-16 h-[100%] md:mt-0 justify-center space-y-6 sm:w-[350px]">
